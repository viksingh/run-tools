 ...
 */
export function resolveModel(requestedModel, useGemini3_1 = false, useCustomToolModel = false) {
 ...
 * @returns The resolved concrete model name.
 */
export function resolveClassifierModel(requestedModel, modelAlias, useGemini3_1 = false, useCustomToolModel = false) {
...
export function getDisplayString(model) {
    switch (model) {
        case PREVIEW_GEMINI_MODEL_AUTO:
 ...
 */
export function isActiveModel(model, useGemini3_1 = false, useCustomToolModel = false) {
