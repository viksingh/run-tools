...
import {} from './detect-ide.js';
const logger = {
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    debug: (...args) => debugLogger.debug('[DEBUG] [IDEConnectionUtils]', ...args),
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    error: (...args) => debugLogger.error('[ERROR] [IDEConnectionUtils]', ...args),
};
export function validateWorkspacePath(ideWorkspacePath, cwd) {
...
export function getPortFromEnv() {
...
export function getStdioConfigFromEnv() {
...
export async function getConnectionConfigFromFile(pid) {
...
export async function createProxyAwareFetch(ideServerHost) {
...
//# sourceMappingURL=ide-connection-utils.js.map