...
export class WriteFileTool extends BaseDeclarativeTool {
    ...
    constructor(config, messageBus) {
        super(WriteFileTool.Name, 'WriteFile', WRITE_FILE_DEFINITION.base.description, Kind.Edit, WRITE_FILE_DEFINITION.base.parametersJsonSchema, messageBus, true, false);
        this.config = config;
    }
