...
export class ExitPlanModeTool extends BaseDeclarativeTool {
    ...
    constructor(config, messageBus) {
        ...
        super(EXIT_PLAN_MODE_TOOL_NAME, 'Exit Plan Mode', 'Signals that the planning phase is complete and requests user approval to start implementation.', Kind.Plan, {
            type: 'object',
            required: ['plan_path'],
            properties: {
                plan_path: {
