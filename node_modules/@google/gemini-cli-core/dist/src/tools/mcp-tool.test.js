...
describe('DiscoveredMCPTool', () => {
    ...
    describe('execute', () => {
        ...
        it.each([
            ...
            const tool = new DiscoveredMCPTool(mockCallableToolInstance, serverName, serverToolName, baseDescription, inputSchema, createMockMessageBus(), undefined, undefined, undefined, undefined, undefined, undefined);
    ...
    describe('shouldConfirmExecute', () => {
        it('should return false if trust is true', async () => {
            const trustedTool = new DiscoveredMCPTool(mockCallableToolInstance, serverName, serverToolName, baseDescription, inputSchema, createMockMessageBus(), true, undefined, undefined, { isTrustedFolder: () => true }, undefined, undefined);
    ...
    describe('shouldConfirmExecute with folder trust', () => {
        ...
        it.each([
            ...
            const bus = createMockMessageBus();
            getMockMessageBusInstance(bus).defaultToolDecision = 'ask_user';
            const testTool = new DiscoveredMCPTool(mockCallableToolInstance, serverName, serverToolName, baseDescription, inputSchema, bus, trust, undefined, undefined, mockConfig(isTrusted), undefined, undefined);
