...
import { hasValidEditorCommand, hasValidEditorCommandAsync, getDiffCommand, openDiff, allowEditorTypeInSandbox, isEditorAvailable, isEditorAvailableAsync, resolveEditorAsync, } from './editor.js';
...
describe('editor utils', () => {
    ...
    const mockExecAsync = (implementation) => {
