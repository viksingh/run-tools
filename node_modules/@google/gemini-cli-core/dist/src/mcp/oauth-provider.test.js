...
describe('MCPOAuthProvider', () => {
    ...
    describe('authenticate', () => {
        ...
        it('should include server name in the authentication message', async () => {
            ...
            expect(getConsentForOauth).toHaveBeenCalledWith(expect.stringContaining('production-server'));
        });
        ...
        it('should throw FatalCancellationError when consent is denied', async () => {
            ...
            vi.useFakeTimers();
            const authProvider = new MCPOAuthProvider();
            await expect(authProvider.authenticate('test-server', mockConfig)).rejects.toThrow(FatalCancellationError);
