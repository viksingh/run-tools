...
describe('<ShellToolMessage />', () => {
    ...
    const renderShell = (props = {}, options = {}) => renderWithProviders(_jsx(ShellToolMessage, { ...baseProps, ...props }), {
        uiActions,
        ...options,
    });
    beforeEach(() => {
    ...
    describe('interactive shell focus', () => {
        ...
        it('resets focus when shell finishes', async () => {
            ...
            const Wrapper = () => {
                ...
                return (_jsx(ShellToolMessage, { ...baseProps, status: status, embeddedShellFocused: true, activeShellPtyId: 1, ptyId: 1 }));
            };
            const { lastFrame } = renderWithProviders(_jsx(Wrapper, {}), {
                uiActions,
