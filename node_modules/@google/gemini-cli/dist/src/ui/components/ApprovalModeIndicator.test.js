...
describe('ApprovalModeIndicator', () => {
    ...
    it('renders correctly for AUTO_EDIT mode with plan enabled', () => {
        const { lastFrame } = render(_jsx(ApprovalModeIndicator, { approvalMode: ApprovalMode.AUTO_EDIT, isPlanEnabled: true }));
        expect(lastFrame()).toMatchSnapshot();
    });
    ...
    it('renders correctly for DEFAULT mode with plan enabled', () => {
        const { lastFrame } = render(_jsx(ApprovalModeIndicator, { approvalMode: ApprovalMode.DEFAULT, isPlanEnabled: true }));
        expect(lastFrame()).toMatchSnapshot();
    });
});
